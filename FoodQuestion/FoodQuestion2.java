...
public class FoodQuestion2 extends JFrame {
	...
	private class MyActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (b.getText().equals("이전으로")) {
				// 이전페이지로 이동
				//new FoodQuestion1();
				FoodQuestion2.this.setVisible(false);
			}
		}
	}
	...
	private class MyActionListener_R implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			JButton b = (JButton) e.getSource();
			if (b.getText().equals("배부르다")) {
				new FoodQuestion3(FoodQuestion2.this.name);
				FoodQuestion2.this.setVisible(false);
			} else if (b.getText().equals("배고프다")) {
				new FoodQuestion3_2(FoodQuestion2.this.name);
				FoodQuestion2.this.setVisible(false);
			}
		}
	}
