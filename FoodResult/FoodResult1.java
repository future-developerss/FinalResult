...
import javax.swing.*;
public class FoodResult1 extends JFrame {
	...
	public FoodResult1(String msg) {
		...
		mainImage = new ImageIcon("images/food_result1.jpg");
		mainImage = imageSize(mainImage, 250,130);
		result_img = new JLabel("떡볶이", mainImage, JLabel.CENTER);
		...
		FoodBrand1 R1brand = new FoodBrand1();
		FoodCombi1 R1combi = new FoodCombi1();
		FoodDessert1 R1dessert = new FoodDessert1();
	...
	private class MyActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (b.getText().equals("이전으로")) {
				new FoodQuestion3(FoodResult1.this.name);
