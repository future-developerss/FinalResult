...
import javax.swing.*;
public class FoodBrand5 extends JPanel {
	...
	public FoodBrand5() {
		...
		brand1 = new ImageIcon("images/R5brand1.png");
		brand1 = imageSize(brand1, 100,100);
		brand1_e = new JLabel("대표 메뉴",JLabel.LEFT);
		brand1_m = new JLabel("<html>퀸즈랜드 립아이(57,000)<br>베이비 백 립(37,900)</html>", JLabel.LEFT);
		p1.add(brand1_e);
		p1.add(brand1_m);

		brand2 = new ImageIcon("images/R5brand2.png");
		brand2 = imageSize(brand2, 100,100);
		brand2_e = new JLabel("대표 메뉴", JLabel.LEFT);
		brand2_m = new JLabel("<html>빕스NO.1 스테이크(37,800)<br>립아이스테이크(36,800)</html>",JLabel.LEFT);
		p3.add(brand2_e);
		p3.add(brand2_m);
		
		brand1_n = new JLabel("아웃백", brand1, JLabel.RIGHT);
		brand1_n = setLabel(brand1_n);
		brand1_n.setFont(font_13);
		p2.add(brand1_n);
		
		brand2_n = new JLabel("빕스", brand2, JLabel.RIGHT);
