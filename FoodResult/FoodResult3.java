...
import javax.swing.*;
public class FoodResult3 extends JFrame {
	...
	public FoodResult3(String msg) {
		...
		mainImage = new ImageIcon("images/food_result3.jpg");
		mainImage = imageSize(mainImage, 250,130);
		result_img = new JLabel("초밥", mainImage, JLabel.CENTER);
		...
		FoodBrand3 R1brand = new FoodBrand3();
		FoodCombi3 R1combi = new FoodCombi3();
		FoodDessert3 R1dessert = new FoodDessert3();
	...
	private class MyActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (b.getText().equals("이전으로")) {
				new FoodQuestion3(FoodResult3.this.name);
				FoodResult3.this.setVisible(false);
