...
import javax.swing.*;
public class FoodResult5 extends JFrame {
	...
	public FoodResult5(String msg) {
		...
		mainImage = new ImageIcon("images/food_result5.jpg");
		mainImage = imageSize(mainImage, 250,130);
		result_img = new JLabel("스테이크", mainImage, JLabel.CENTER);
		...
		FoodBrand5 R1brand = new FoodBrand5();
		FoodCombi5 R1combi = new FoodCombi5();
	...
	private class MyActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (b.getText().equals("이전으로")) {
				new FoodQuestion3_2(FoodResult5.this.name);
				FoodResult5.this.setVisible(false);
