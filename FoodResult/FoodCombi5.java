...
import javax.swing.*;
public class FoodCombi5 extends JPanel {
	...
	public FoodCombi5() {
		...
		combi1 = new JLabel("· 파스타",JLabel.LEFT);
		combi1_e = new JLabel("<html>둘 중 하나를 고르기 힘드니 둘 다!<br><br></html>", JLabel.LEFT);
		p1.add(combi1);
		p1.add(combi1_e);
		combi2 = new JLabel("· 감자튀김", JLabel.LEFT);
		combi2_e = new JLabel("<html>양식과 어울리는 바삭한 감자튀김<br><br></html>",JLabel.LEFT);	
		p3.add(combi2);
		p3.add(combi2_e);
	...
	public class ShowListener implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			if(e.getSource() == show) {
				String[] combi_food = {"파스타", "감자튀김", "탄산음료"};
