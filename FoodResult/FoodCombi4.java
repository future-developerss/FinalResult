...
import javax.swing.*;
public class FoodCombi4 extends JPanel {
	...
	public FoodCombi4() {
		...
		combi1 = new JLabel("· 새우튀김",JLabel.LEFT);
		combi1_e = new JLabel("<html>바삭한 새우튀김과 함께!<br><br></html>", JLabel.LEFT);
		p1.add(combi1);
		p1.add(combi1_e);
		combi2 = new JLabel("· 샐러드", JLabel.LEFT);
		combi2_e = new JLabel("<html>느끼함을 잡아줄 샐러드<br><br></html>",JLabel.LEFT);	
		p3.add(combi2);
		p3.add(combi2_e);
	...
	public class ShowListener implements ActionListener{
		public void actionPerformed(ActionEvent e) {
			if(e.getSource() == show) {
				String[] combi_food = {"새우튀김", "샐러드", "탄산음료"};
