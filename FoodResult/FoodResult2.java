...
import javax.swing.*;
public class FoodResult2 extends JFrame {
	...
	public FoodResult2(String msg) {
		...
		mainImage = new ImageIcon("images/food_result2.jpg");
		mainImage = imageSize(mainImage, 250,130);
		result_img = new JLabel("간장게장", mainImage, JLabel.CENTER);
		...
		FoodBrand2 R1brand = new FoodBrand2();
		FoodCombi2 R1combi = new FoodCombi2();
		FoodDessert2 R1dessert = new FoodDessert2();
	...
	private class MyActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (b.getText().equals("이전으로")) {
				new FoodQuestion3_2(FoodResult2.this.name);
				FoodResult2.this.setVisible(false);
