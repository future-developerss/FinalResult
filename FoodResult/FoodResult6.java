...
import javax.swing.*;
public class FoodResult6 extends JFrame {
	...
	public FoodResult6(String msg) {
		...
		mainImage = new ImageIcon("images/food_result6.jpg");
		mainImage = imageSize(mainImage, 250,130);
		result_img = new JLabel("샐러드", mainImage, JLabel.CENTER);
		...
		FoodBrand6 R1brand = new FoodBrand6();
		FoodCombi6 R1combi = new FoodCombi6();
		FoodDessert4 R1dessert = new FoodDessert4();
		
		tab_panel = new JTabbedPane();
		tab_panel.addTab("판매 브랜드", R1brand);
		tab_panel.addTab("어울리는 토핑", R1combi);
	...
	private class MyActionListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			if (b.getText().equals("이전으로")) {
				new FoodQuestion3(FoodResult6.this.name);
				FoodResult6.this.setVisible(false);
